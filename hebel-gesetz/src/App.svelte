...
<p class="text-center font-popppins font-bold p-2 text-orange-500 text-xl">Beispiele von ausgeglichenen Hebeln</p>
<Rechnung formel={[[2,6,1,12], [4,2,1,8], [5,4,4,5], [1,6,2,3], [1,20,4,5]]}></Rechnung>
